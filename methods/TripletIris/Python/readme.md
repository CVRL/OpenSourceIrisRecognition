...
2. Download the models from [this Google folder](https://drive.google.com/drive/folders/1Ek3YA7JJEcqlfp1V9uz2xfX3kBCeVRPZ?usp=sharing), and copy them to the `models` folder.
