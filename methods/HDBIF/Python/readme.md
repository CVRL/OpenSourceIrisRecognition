...
2. Download the segmentation models and the filtering kernels from [this Google folder](https://drive.google.com/drive/folders/1GU3jccid9ljghZrV5CvcLY4xuhWSaEsM?usp=sharing), and copy them to the `models` and `filters_pt` folders, respectively.
