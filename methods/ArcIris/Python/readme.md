...
2. Download the models from [this Google folder](https://drive.google.com/drive/folders/1TrDiqw5-JyIIP9pEwB742yNwjg-IeN3j?usp=sharing) and copy them to the `models` folder.
...
1. Run / analyze `arciris.py`, which loads all images from the `data` folder, performs the segmentation, feature extraction and all-vs-all matching to demonstrate how to call various functions in the ArcIris method's pipeline.
