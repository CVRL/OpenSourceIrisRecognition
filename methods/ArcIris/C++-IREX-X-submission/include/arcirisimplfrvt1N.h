...
#ifndef ArcIrisImplFRVT1N_H_
#define ArcIrisImplFRVT1N_H_
 ...
 */
namespace FRVT_1N {
  class ArcIrisImplFRVT1N : public FRVT_1N::Interface {
    private:
